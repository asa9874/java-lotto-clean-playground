...
public class LottoOutputView {
    ...
    private void printEachRankStatistics(HashMap<WinningRank, Integer> winningStatistics) {
        System.out.println("3개 일치 (5000원)- " + winningStatistics.get(WinningRank.FOURTH) + "개");
        System.out.println("4개 일치 (50000원)- " + winningStatistics.get(WinningRank.THIRD) + "개");
        System.out.println("5개 일치 (1500000원)- " + winningStatistics.get(WinningRank.SECOND) + "개");
